...
import { Share2, Download, BarChart2, LineChart as LineChartIcon, AreaChart as AreaChartIcon, Check, Info, GraduationCap, ChevronDown, ChevronUp } from 'lucide-react'
    ...
    return (
      <div className="h-[400px] flex items-center justify-center bg-[var(--input-bg)] rounded-lg border border-dashed border-[var(--border-color)]">
        <div className="text-center space-y-3">
          <GraduationCap className="h-12 w-12 text-[var(--text-secondary)] mx-auto opacity-50" />
          <div>
            <p className="text-[var(--text-primary)] font-medium">No Education Data Available</p>
            <p className="text-[var(--text-secondary)] text-sm">Education metrics will appear here once data is loaded</p>
          </div>
        </div>
      </div>
    )
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 p-4 bg-[var(--input-bg)] rounded-lg border border-[var(--border-color)]">
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-semibold text-[var(--text-primary)]">Education Analysis</h3>
          </div>
